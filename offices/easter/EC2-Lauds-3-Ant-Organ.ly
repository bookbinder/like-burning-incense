...
\include "notes/EC2-Lauds-3-Ant.ily"
\include #(string-append "/home/ryan/scores/like-burning-incense/psalmtones/notes/" psalmtone "-notes.ily")
% \include "/home/ryan/scores/like-burning-incense/psalmtones/toneInfo.ily"
% #(define keysig (string-append "\\key " (assoc psalmtone toneKey)))
%% update again
