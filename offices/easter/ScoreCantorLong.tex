...
%% \chapter{Easter, Week I}

%% \section{Sunday Morning Prayer}
%% \input{EA1-Lauds-Cantor.tex}

%% \section{Monday Morning Prayer}
%% \input{EA2-Lauds-Cantor.tex}

%% \section{Tuesday Morning Prayer}
%% \input{EA3-Lauds-Cantor.tex}

%% \section{Wednesday Morning Prayer}
%% \input{EA4-Lauds-Cantor.tex}

%% \section{Thursday Morning Prayer}
%% \input{EA5-Lauds-Cantor.tex}

%% \section{Friday Morning Prayer}
%% \input{EA6-Lauds-Cantor.tex}

%% \section{Saturday Morning Prayer}
%% \input{EA7-Lauds-Cantor.tex}



%% \chapter{Easter, Week II}
...
%% \chapter{Easter, Week IV}

%% \section{Sunday Morning Prayer}
%% \input{ED1-Lauds-Cantor.tex}

%% \section{Monday Morning Prayer}
%% \input{ED2-Lauds-Cantor.tex}

%% \section{Tuesday Morning Prayer}
%% \input{ED3-Lauds-Cantor.tex}

%% \section{Wednesday Morning Prayer}
%% \input{ED4-Lauds-Cantor.tex}

%% \section{Thursday Morning Prayer}
%% \input{ED5-Lauds-Cantor.tex}

%% \section{Friday Morning Prayer}
%% \input{ED6-Lauds-Cantor.tex}

%% \section{Saturday Morning Prayer}
%% \input{ED7-Lauds-Cantor.tex}


%% \chapter{Easter, Week V}
%% \chaptermark{Easter, Week V}

%% \section{Sunday Morning Prayer}
%% \input{EE1-Lauds-Cantor.tex}

%% \section{Monday Morning Prayer}
%% \input{EE2-Lauds-Cantor.tex}

%% \section{Tuesday Morning Prayer}
%% \input{EE3-Lauds-Cantor.tex}

%% \section{Wednesday Morning Prayer}
%% \input{EE4-Lauds-Cantor.tex}

%% \section{Thursday Morning Prayer}
%% \input{EE5-Lauds-Cantor.tex}

%% \section{Friday Morning Prayer}
%% \input{EE6-Lauds-Cantor.tex}

%% \section{Saturday Morning Prayer}
%% \input{EE7-Lauds-Cantor.tex}

%% \chapter{Easter, Week VI}

\chaptermark{Easter, Week VI}

%% \section{Sunday Morning Prayer}
%% \input{EF1-Lauds-Cantor.tex}

%% \section{Monday Morning Prayer}
%% \input{EF2-Lauds-Cantor.tex}

%% \section{Tuesday Morning Prayer}
%% \input{EF3-Lauds-Cantor.tex}

%% \section{Wednesday Morning Prayer}
%% \input{EF4-Lauds-Cantor.tex}

%% \section{Thursday Morning Prayer}
%% \input{EF5-Lauds-Cantor.tex}

%% \section{Friday Morning Prayer}
%% \input{EF6-Lauds-Cantor.tex}

%% \section{Saturday Morning Prayer}
%% \input{EF7-Lauds-Cantor.tex}

%% \chapter{Easter, Week VII}

%% \section{Sunday Morning Prayer}
%% \input{EG1-Lauds-Cantor.tex}

%% \section{Monday Morning Prayer}
%% \input{EG2-Lauds-Cantor.tex}

%% \section{Tuesday Morning Prayer}
%% \input{EG3-Lauds-Cantor.tex}

%% \section{Wednesday Morning Prayer}
%% \input{EG4-Lauds-Cantor.tex}

%% \section{The Ascension}
%% \input{Ascension1-Lauds-Cantor.tex}

\section{Thursday Morning Prayer}
\input{EG5-Lauds-Cantor.tex}

%% \section{Friday Morning Prayer}
%% \input{EG6-Lauds-Cantor.tex}

%% \section{Saturday Morning Prayer}
%% \input{EG7-Lauds-Cantor.tex}

%% \chapter{Pentecost}
%% \section{Sunday Morning Prayer}
%% \input{Pentecost1-Lauds-Cantor.tex}
