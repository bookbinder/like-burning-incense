...
\newcommand{\psalmody}{\null\subsection{\textsc{Psalmody}}}
\newcommand{\hymn}{\null\subsection{\textsc{Hymn}}}
\newcommand{\benedictus}{\null\subsection{\textsc{Canticle of Zechariah}}}
\newcommand{\magnificat}{\null\subsection{\textsc{Canticle of Mary}}}
\newcommand{\gospelcanticle}{\null\subsection{\textsc{Gospel Canticle}}}
...
\newcommand{\Desc}[2]{\linespread{0.1}{\noindent\small\emph{#1} #2}}
...
\input{A1-Lauds-Cantor.tex}

\section{Monday Morning Prayer}
\input{A2-Lauds-Cantor.tex}

\section{Tuesday Morning Prayer}
\input{A3-Lauds-Cantor.tex}

\section{Wednesday Morning Prayer}
\input{A4-Lauds-Cantor.tex}

\section{Thursday Morning Prayer}
\input{A5-Lauds-Cantor.tex}
