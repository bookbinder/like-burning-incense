...
\titlespacing*{\paragraph}{0ex}{0ex}{0ex}[0ex]
...
\newcommand{\descA}{}
\newcommand{\descB}{}
\newcommand{\reading}[1]{\subsubsection{\textsc{Reading}\hfill #1}}
\newcommand{\benAbsentSeasons}{{\medskip\color{red}\noindent%
{\textsc{Benedictus}, %
antiphon as in the Proper of %
Seasons.}\medskip}}

\newcommand{\responsory}[4]{\subsubsection{\textsc{Responsory}\hfill\null}%
#1
...
\medskip\noindent Glory to the Father\ldots

\noindent{\color{red}---}#4\ldots
}
\newcommand{\intercessions}{\subsubsection{\textsc{Intercessions}\hfill\null}}
%% \raggedright
\raggedbottom
