...
text = \lyricmode {
    ...
    Let the peo -- ple of Zi -- on  \markup \with-color #(x11-color 'gray36) { \tiny \raise #.5 \char ##x1F7B6 }
...
sopNotesAnt = \relative e' {
    ...
    \hideNotes f16 \unHideNotes   %so that I can align the * better
     f8 \bar "" ees[ f] ees des \bar "" f4 \breathe \allowBreak 
    ees8 des \bar "" \allowBreak  des[ c] \allowBreak c4 \bar "||"
}
