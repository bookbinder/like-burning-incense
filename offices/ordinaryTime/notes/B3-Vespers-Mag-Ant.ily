...
text = \lyricmode {
    ...
    Do great things for us, O Lord, \markup \with-color #(x11-color 'gray36) { \tiny \raise #.5 \char ##x1F7B6 }
...
sopNotesAnt = \relative e' {
    ...
    g8 g aes \bar "" f \allowBreak ees \allowBreak des \bar "" f \allowBreak f ees des c4 \bar "||"
}
