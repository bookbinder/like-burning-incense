...
\titlespacing*{\paragraph}{0ex}{1ex}{.5exex}[0ex]
...
\newcommand{\saintHeading}[3]{\chapter*{\Large\MakeUppercase{#1}\\\large\emph{#2}\\\normalsize{#3}}\chaptermark{#3---#1}}

\begin{document}

\saintHeading{Saints Peter and Paul, Apostles}{Solemnity}{June 29}
