...
%textB = \lyricmode {
    ...
    sopNotesAnt = \relative e' {
        ...
        \voiceOne
        cis8^\markup { \italic \bold "The first note in soprano might be b.]" } dis e dis cis gis'4 gis8 \bar "" fis[ gis] \bar "" b[ gis] \bar "" gis4
    ...
    altoNotesAnt = \relative c' {
        \global
        \voiceTwo
        gis1^\markup { \italic \bold "[The associated psalm tone might also be a variant of 24, 31, or 36." } b4 dis4 e4. s16 
