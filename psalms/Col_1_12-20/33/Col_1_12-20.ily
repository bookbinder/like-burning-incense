...
%   \set shortVocalName = "1."
    ...
    \ll "He rescued us from the pow" -- er of \ll darkness
    ...
    \ll "He is the image of the invi" -- si -- ble God,
    ...
    \ll "All were crea" -- ted through him;
...
%    \set shortVocalName = "2."
    ...
    \ll "It pleased God to make absolute fullness re" -- side in him
