...
%    \set shortVocalName = "1."
    ...
    \ll "Let the steppe and its cities" cry out,
    \ll "the villages where Ke" -- dar dwells;
    
    \ll "Let the inhabitants of Sela" e -- xult,
    ...
    \ll "but now, I cry out as a woman" in labor,
    \ll "gasping" and panting.
    
    \ll "I will lay waste mountains" and hills,
