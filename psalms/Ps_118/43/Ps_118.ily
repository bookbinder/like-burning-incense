...
%    \set shortVocalName = "1."
    ...
    \ll "Let the sons of Is" -- ra -- el say:
    \ll "‘His love endures" for ever.’
    ...
    \ll "he answered" and \ll "freed me."
...
%    \set shortVocalName = "2."
    ...
    \ll "The Lord’s right" hand has triumphed;
    \ll "I shall not die, I shall live and recount" his deeds.
    ...
    \ll "The stone which the buil" -- ders re -- jected
...
%    \set shortVocalName = "3."
    ...
    \ll "Go forward in proces" -- sion with branches
