text = \lyricmode {
   ...
   % \set shortVocalName = "1."
    ...
    \ll "The Lord’s voice shatter" -- ing the cedars,
    ...
    \ll "The Lord’s voice sha" -- king the wilderness,
        \ll "the Lord shakes the wilderness" of Kadesh;
    \ll "the Lord’s voice ren" -- ding the "oak tree"
        \ll "and stripping the fo" -- rest bare.

    \ll "The God of" glo -- ry thunders.
        \ll "In his temple they all" cry: ‘Glory!’
    \ll "The Lord sat enthroned o" -- ver the flood;
