...
%    \set shortVocalName = "1."
    ...
    \ll "O Lord, you have" been our refuge
    \ll "from one generation" to the next.

    \ll "Before the mountains were" born
    \ll "or the earth or the" world brought forth,
    \ll "you are God, without begin" -- ning or end.
    
    \ll "You turn men" back to dust
    \ll "and say: Go back," sons of men.

    \ll "To your eyes a thousand" years
    \ll "are like yesterday," come and gone,
    \ll "no more than a watch" in the night.
    ...
    \ll "by evening it wi" -- thers and fades.
    ...
    \ll "All our days pass away" in your anger.
    \ll "Our life is over" like a sigh.
...
%    \set shortVocalName = "2."
    ...
    \ll "that we may gain wis" -- dom of heart.
    ...
    \ll "Let the favor of the Lord be u" -- "pon us:"
    \ll "give success to the work" of our hands,
    \ll "give success to the work" of our hands.
