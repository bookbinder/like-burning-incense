...
sopranoOneFlex = { \afterGrace a'\breve^"A†" g'4 \bar "'" a'\breve g'8 f'4 \bar "|" g'\breve bes'8 a'4 \bar "||"}
sopranoOne = {a'\breve^"A" g'8 f'4 \bar "|" g'\breve bes'8 a'4 \bar "||"}
sopranoShort = { \override Stem.stencil = ##f
                 \afterGrace a'\breve*1/2 \parenthesize g'4_"+"
                 \revert Stem.stencil
                 g'8 f'4 \bar "|" \allowBreak g'\breve*1/2 bes'8 a'4 \bar "||"  }
sopranoTwoFlex = { \afterGrace a'\breve^"B†" g'4 \bar "'" a'\breve g'8 f'4 \bar "|" g'\breve bes'8 a'4 \bar "||"}
