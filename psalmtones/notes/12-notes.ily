...
sopranoOneFlex = { \afterGrace a'\breve^"A†" g'4 \bar "'" a'\breve g'8 f'4 \bar "|" g'\breve f'8 d' f'4 \bar "||" }
...
sopranoTwoFlex = { \afterGrace a'\breve^"B†" g'4 \bar "'" a'\breve g'8 f'4 \bar "|" g'\breve  f'8 d' f'4 \bar "||" }
...
tenorOneFlex = { \afterGrace c'\breve bes4 \bar "'" c'\breve~ s8 c'4 \bar "|" bes\breve s4 a4 \bar "||"}
tenorOne = {  c'\breve~ s8 c'4 \bar "|" bes\breve s4 a4 \bar "||" }
tenorTwoFlex = { \afterGrace a\breve bes4 \bar "'" a\breve~ s8 a4 \bar "|" bes\breve s4 a4 \bar "||"}
