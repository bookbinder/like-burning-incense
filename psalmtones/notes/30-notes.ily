...
sopranoOneFlex = { \afterGrace aes'\breve^"A† sounds bad" f'4 \breathe  aes'\breve ces''8 bes'4 \bar "|" aes'\breve f'4 \bar "||" }
sopranoOne = { aes'\breve^"A sounds bad" ces''8 bes'4 \bar "|" aes'\breve f'4 \bar "||" }
