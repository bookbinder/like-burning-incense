...
sopranoOneFlex = { \afterGrace aes'\breve^"A†" f'4 \bar "'"  aes'\breve f'8 ges' aes'4 \bar "|" ges'\breve aes'8 des'4 \bar "||" }
...
sopranoTwoFlex = { \afterGrace aes'\breve^"B†" f'4 \bar "'"  aes'\breve f'8 ges' aes'4 \bar "|" ges'\breve aes'8 des'4 \bar "||" }
