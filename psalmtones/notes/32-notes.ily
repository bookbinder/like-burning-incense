...
sopranoOneFlex = { \afterGrace aes'\breve^"A†" f'4 \bar "'"  aes'\breve bes'8 aes'4 \bar "|" f'\breve ees'8 f'4 \bar "||" }
sopranoOne = { aes'\breve^"A" bes'8 aes'4 \bar "|" f'\breve ees'8 f'4 \bar "||" }
sopranoShort = { \override Stem.stencil = ##f
                 \afterGrace aes'\breve*1/2 \parenthesize f'4_"+"
                 \revert Stem.stencil
                 bes'8 aes'4 \bar "|" \allowBreak f'\breve*1/2 ees'8 f'4 \bar "||"  }
sopranoTwoFlex = { \afterGrace aes'\breve^"B†" f'4 \bar "'"  aes'\breve bes'8 aes'4 \bar "|" f'\breve ees'8 f'4 \bar "||" }
...
tenorOneFlex = { \afterGrace f\breve bes4 \bar "'" f\breve s8 aes4 \bar "|" ges\breve s8 f4 \bar "||" }
tenorOne = { f\breve s8 aes4 \bar "|" ges\breve s8 f4 \bar "||" }
tenorTwoFlex = { \afterGrace c'\breve des'4 \bar "'" c'\breve~ s8 c'4 \bar "|" bes\breve s8 aes4 \bar "||" }
