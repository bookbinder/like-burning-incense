...
sopranoTwoFlex = {  aes'\breve^"B†" f'4 \bar "'"  aes'\breve bes'8 aes'4 \bar "|" f'\breve ees'8 des'4 \bar "||" }
...
tenorOneFlex = {  f\breve bes4 \bar "'" f\breve s8 aes4 \bar "|" ges\breve s8 f4 \bar "||" }
tenorOne = { f\breve s8 aes4 \bar "|" ges\breve s8 f4 \bar "||" }
tenorTwoFlex = {  f\breve bes4 \bar "'" f\breve s8 aes4~ \bar "|" aes\breve s8 f4 \bar "||" }
