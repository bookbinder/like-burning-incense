...
sopranoOneFlex = { \afterGrace aes'\breve^"A†" f'4 \bar "'"  aes'\breve f'8 des'4 \bar "|" ees'\breve f'8 des'4 \bar "||" }
...
sopranoTwoFlex = { \afterGrace aes'\breve^"B†" f'4 \bar "'"  aes'\breve f'8 des'4 \bar "|" ees'\breve f'8 des'4 \bar "||" }
...
tenorOneFlex = { \afterGrace f\breve bes4 \bar "'" f\breve~ s8 f4 \bar "|" ges\breve s8 f4 \bar "||" }
