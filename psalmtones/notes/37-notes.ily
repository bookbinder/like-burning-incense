...
sopranoOneFlex = { \afterGrace a'\breve^"A†" fis'4 \bar "'" \bar ""  a'\breve b'8 a'4 \bar "|" g'\breve e'8 d'4 \bar "||" }
...
sopranoTwoFlex = { \afterGrace a'\breve^"B†" fis'4 \bar "'" \bar ""  a'\breve b'8 a'4 \bar "|" g'\breve e'8 d'4 \bar "||" }
