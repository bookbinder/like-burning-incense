...
sopranoOneFlex = {  a'\breve^"A†" g'4 \bar "'" \bar "" a'\breve g'8 f' g'4 \bar "|" g'\breve f'8 d'4 \bar "||"  }
...
sopranoTwoFlex = {  a'\breve^"B†" g'4 \bar "'" \bar "" a'\breve g'8 f' g'4 \bar "|" \noBreak g'\breve f'8 d'4 \bar "||"   }
...
tenorOneFlex = {  f\breve g4 \bar "'" f\breve~ s4 f4 \bar "|" g\breve s8 f4 \bar "||"  }
tenorOne = { f\breve~ s4 f4 \bar "|" g\breve s8 f4 \bar "||"  }
tenorTwoFlex = {  f\breve g4 \bar "'" f\breve s4 e4 \bar "|" f\breve~ s8 f4 \bar "||" }
