...
sopranoOneFlex = { \afterGrace f'\breve^"A†" d'4 \bar "'" \bar "" f'\breve a'8 g'4 \bar "|" g'\breve f'8 d'4 \bar "||" }
...
sopranoTwoFlex = { \afterGrace f'\breve^"B†" d'4 \bar "'" \bar "" f'\breve a'8 g'4 \bar "|" g'\breve f'8 d'4 \bar "||" }
...
tenorOneFlex = { \afterGrace f\breve g4 \bar "'" f\breve s8 g4 \bar "|" bes\breve s8 f4 \bar "||" }
tenorOne = { f\breve s8 g4 \bar "|" bes\breve s8 f4 \bar "||" }
tenorTwoFlex = { \afterGrace f\breve g4 \bar "'" f\breve s8 bes4 \bar "|" e\breve s8 f4 \bar "||" }
