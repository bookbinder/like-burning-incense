...
sopranoOneFlex = { \afterGrace aes'\breve^"A†" f'4 \bar "'" aes'\breve bes'8 aes'4 \bar "|" g'\breve aes'8 f'4 \bar "||" }
...
sopranoTwoFlex = { \afterGrace aes'\breve^"B†" f'4 \bar "'" aes'\breve bes'8 aes'4 \bar "|" g'\breve aes'8 f'4 \bar "||" }
...
tenorOneFlex = { \afterGrace aes\breve bes4 \bar "'" aes\breve~ s8 aes4 \bar "|" bes\breve s8 aes4 \bar "||" }
