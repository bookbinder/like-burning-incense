...
sopranoOneFlex = { \afterGrace aes'\breve^"A†" f'4 \bar "'" aes'\breve bes'8 aes'4 \bar "|" g'\breve ees'8 f'4  \bar "||" }
sopranoOne = { aes'\breve^"A" bes'8 aes'4 \bar "|" g'\breve ees'8 f'4 }
sopranoShort = { \override Stem.stencil = ##f
                 \afterGrace aes'\breve*1/2 \parenthesize f'4_"+"
                 \revert Stem.stencil
                 bes'8 aes'4 \bar "|" \allowBreak g'\breve*1/2 ees'8 f'4 \bar "||"  }
sopranoTwoFlex = { \afterGrace aes'\breve^"B†" f'4 \bar "'" aes'\breve bes'8 aes'4 \bar "|" g'\breve ees'8 f'4  \bar "||" }
...
tenorOneFlex = { \afterGrace aes\breve bes4 \bar "'" aes\breve s8 s4 \bar "|" bes\breve s8 aes4 \bar "||" }
tenorOne = { aes\breve s8 s4 \bar "|" bes\breve s8 aes4 \bar "||" }
tenorTwoFlex = { \afterGrace aes\breve bes4 \bar "'" aes\breve ~ s8 aes4 \bar "|" bes\breve s8 aes4 \bar "||" }
