...
sopranoOneFlex = { \afterGrace gis'\breve^"A†" fis'4 \bar "'" gis'\breve fis'8 gis' ais'4 \bar "|" gis'\breve fis'8 dis'4 \bar "||" }
sopranoOne = { gis'\breve^"A" fis'8 gis' ais'4 \bar "|" gis'\breve fis'8 dis'4 \bar "||" }
sopranoShort = { \override Stem.stencil = ##f
                 \afterGrace gis'\breve*1/2 \parenthesize fis'4_"+"
                 \revert Stem.stencil
                 fis'8 gis' ais'4 \bar "|" \allowBreak gis'\breve*1/2 fis'8 dis'4 \bar "||"  }
sopranoTwoFlex = { \afterGrace gis'\breve^"B†" fis'4 \bar "'" gis'\breve fis'8 gis' ais'4 \bar "|" gis'\breve fis'8 dis'4 \bar "||" }
...
tenorOneFlex = { \afterGrace b\breve ais4 \bar "'" b\breve s4 ais4 \bar "|" cis'\breve s8 b4 \bar "||" }
tenorOne = { b\breve s4 ais4 \bar "|" cis'\breve s8 b4 \bar "||" }
tenorTwoFlex = { \afterGrace gis\breve ais4 \bar "'" gis\breve s4 fis4 \bar "|" e\breve s8 gis4 \bar "||"}
