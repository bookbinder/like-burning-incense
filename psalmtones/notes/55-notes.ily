...
sopranoOneFlex = { \afterGrace gis'\breve^"A†" fis'4 \bar "'"  gis'\breve fis'8 dis'4 \bar "|" ais'\breve gis'4 \bar "||" }
...
sopranoTwoFlex = { \afterGrace gis'\breve^"B†" fis'4 \bar "'"  gis'\breve fis'8 dis'4 \bar "|" ais'\breve gis'4 \bar "||" }
...
tenorOneFlex = { \afterGrace cis'\breve ais4 \bar "'" cis'\breve s8 b4 \bar "|" cis'\breve b4 \bar "||" }
tenorOne = { cis'\breve s8 b4 \bar "|" cis'\breve b4 \bar "||" }
tenorTwoFlex = { \afterGrace gis\breve ais4 \bar "'" gis\breve~ s8 gis4 \bar "|" fis\breve dis4 \bar "||" }
