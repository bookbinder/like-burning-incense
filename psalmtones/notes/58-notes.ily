...
sopranoOneFlex = { \afterGrace gis'\breve^"A†" fis'4 \bar "'" \bar "" gis'\breve fis'8 gis'4 \bar "|" fis'\breve e'8 cis'4 \bar "||" }
...
sopranoTwoFlex = { \afterGrace gis'\breve^"B†" fis'4 \bar "'" \bar "" gis'\breve fis'8 gis'4 \bar "|" fis'\breve e'8 cis'4 \bar "||"  }
