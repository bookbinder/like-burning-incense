...
sopranoOneFlex = {\afterGrace aes'\breve^"A†" f'4 \bar "'" aes'\breve g'8 f' aes'4 \bar "|" g'\breve f'8 ees'4 \bar "||"}
...
sopranoTwoFlex = {\afterGrace aes'\breve^"B†" f'4 \bar "'" aes'\breve g'8 f' aes'4 \bar "|" g'\breve f'8 ees'4 \bar "||"}
