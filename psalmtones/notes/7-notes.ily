...
sopranoOneFlex = { \afterGrace g'\breve^"A†" e'4 \bar "'" g'\breve f'8 e' d'4 \bar "|" a'\breve b'8 g'4 \bar "||"  }
sopranoOne = { g'\breve^"A" f'8 e' d'4 \bar "|" a'\breve b'8 g'4 \bar "||" }
sopranoShort = { \override Stem.stencil = ##f
                 \afterGrace g'\breve*1/2 \parenthesize e'4_"+"
                 \revert Stem.stencil
                 f'8 e' d'4 \bar "|" \allowBreak a'\breve*1/2 b'8 g'4 \bar "||"  }
sopranoTwoFlex = { \afterGrace g'\breve^"B†" e'4 \bar "'" g'\breve f'8 e' d'4 \bar "|" a'\breve b'8 g'4 \bar "||"  }
