...
sopranoOneFlex = { \afterGrace g'\breve^"A†" f'4 \bar "'" \bar "" g'\breve a'8 g'4 \bar "|" g'\breve f'8 e'4 \bar "||"  }
...
sopranoTwoFlex = { \afterGrace g'\breve^"B†" f'4 \bar "'" \bar "" g'\breve a'8 g'4 \bar "|" g'\breve f'8 e'4 \bar "||"  }
