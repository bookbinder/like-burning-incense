...
sopranoOneFlex = { \afterGrace a'\breve^"A†" g'4 \bar "'" a'\breve f'8 g'4 \bar "|" f'\breve e'8 d'4 \bar "||" }
...
sopranoTwoFlex = { \afterGrace a'\breve^"B†" g'4 \bar "'" a'\breve f'8 g'4 \bar "|" f'\breve e'8 d'4 \bar "||" }
...
tenorOneFlex = { \afterGrace a\breve bes4 \bar "'" a\breve s8 g4~ \bar "|" g\breve s8 f4 \bar "||" }
tenorOne = { a\breve s8 g4~ \bar "|" g\breve s8 f4 \bar "||" }
tenorTwoFlex = { \afterGrace a\breve bes4 \bar "'" a\breve s8 bes4 \bar "|" g\breve s8 f4 \bar "||" }
tenorTwo = { a\breve s8 bes4 \bar "|" g\breve s8 f4 \bar "||" }

bassOneFlex = { \afterGrace d\breve g4 d\breve s8 bes,4 g,\breve s8 d4 }
bassOne = { d\breve s8 bes,4 g,\breve s8 d4 }
bassTwoFlex = { \afterGrace f\breve~ f4~ f\breve s8 bes,4 d\breve~ s8 d4 }
