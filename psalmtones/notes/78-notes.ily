...
sopranoOneFlex = { \afterGrace aes'\breve^"A†" f'4 \bar "'"  aes'\breve f'8 ges' aes'4 \bar "|" ges'\breve ees'8 des'4 \bar "||" }
sopranoOne = { aes'\breve^"A" f'8 ges' aes'4 \bar "|" ges'\breve ees'8 des'4 \bar "||" }
sopranoShort = { \override Stem.stencil = ##f
                 \afterGrace aes'\breve*1/2 \parenthesize f'4_"+"
                 \revert Stem.stencil
                 f'8 ges' aes'4 \bar "|" \allowBreak ges'\breve*1/2 ees'8 des'4 \bar "||"  }
sopranoTwoFlex = { \afterGrace aes'\breve^"B†" f'4 \bar "'"  aes'\breve f'8 ges' aes'4 \bar "|" ges'\breve ees'8 des'4 \bar "||" }
...
tenorOneFlex = { \afterGrace aes\breve bes4 \bar "'" aes\breve s4 f4 \bar "|" ges\breve s8 aes4 \bar "||" }
tenorOne = { aes\breve s4 f4 \bar "|" ges\breve s8 aes4 \bar "||" }
tenorTwoFlex = { \afterGrace f\breve bes4 \bar "'" f\breve s4 ges4~ \bar "|" ges\breve s8 f4 \bar "||" }
