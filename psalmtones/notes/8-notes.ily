...
sopranoOneFlex = { \afterGrace a'\breve^"A†" g'4 \bar "'" a'\breve bes'8 g'4 \bar "|" g'\breve bes'8 a'4 \bar "||"  }
sopranoOne = { a'\breve^"A" bes'8 g'4 \bar "|" g'\breve bes'8 a'4 \bar "||" }
sopranoShort = { \override Stem.stencil = ##f
                 \afterGrace a'\breve*1/2 \parenthesize g'4_"+"
                 \revert Stem.stencil
                 bes'8 g'4 \bar "|" \allowBreak g'\breve*1/2 bes'8 a'4 \bar "||"  }
sopranoTwoFlex = { \afterGrace a'\breve^"B†" g'4 \bar "'" a'\breve bes'8 g'4 \bar "|" g'\breve bes'8 a'4 \bar "||" }
...
tenorOneFlex = { \afterGrace c'\breve bes4 \bar "'" c'\breve s8 bes4 \bar "|" c'\breve~ s8 c'4 \bar "||" }
tenorOne = { c'\breve s8 bes4 \bar "|" c'\breve~ s8 c'4 \bar "||"  }
tenorTwoFlex = { \afterGrace a\breve bes4 \bar "'" a\breve s8 bes4 \bar "|" e\breve s8 f4 \bar "||" }
