...
sopranoOneFlex = { \afterGrace a'\breve^"A†" g'4 \breathe a'\breve g'8 f'8 g'4 \bar "|" g'\breve f'8 g'8 a'4 \bar "||"  }
...
sopranoTwoFlex = { \afterGrace a'\breve^"B†" g'4 \breathe a'\breve g'8 f'8 g'4 \bar "|" g'\breve f'8 g'8 a'4 \bar "||" }
...
tenorOneFlex = { \afterGrace c'\breve bes4 \breathe c'\breve s4 bes4 \bar "|" c'\breve~ s4 c'4 \bar "||" }
tenorOne = { c'\breve s4 bes4 \bar "|" c'\breve~ s4 c'4 \bar "||"  }
tenorTwoFlex = { \afterGrace a\breve bes4 \breathe a\breve s4 bes4 \bar "|" e\breve s4 f4 \bar "||" }
