...
soprano = { a'\breve b'8 a' gis'[ fis'] a'4 \bar "|" a'\breve fis'8 a' gis'4 \bar "||"}
sopranoFlex = { a'\breve \parenthesize fis'4 \soprano  }

altoIntone = { r8 cis'4~  }
alto = { cis'\breve*18/16 e'4 cis'4~ cis'\breve*18/16~ cis'4  }
altoFlex = { cis'\breve*18/16~ \alto  }

tenorIntone = { r8 a4~  }
tenor = { a\breve*18/16 b4 a4~ a\breve*18/16 e4  }
tenorFlex = { a\breve*18/16~ \tenor  }

bassIntone = { r8 <a, e>4~  }
bass = { <a, e~>\breve*18/16 e4 fis4~ <\parenthesize fis, fis>\breve*18/16 cis4 }
