...
soprano = { a'\breve g'8 a' b' a'4 \bar "|"
            a'\breve g'8 a' b' g' e' e'4 \bar "||" }
sopranoFlex = {a'\breve \parenthesize g'4 \soprano }

altoIntone = { r8 c'4~ }
alto = { c'\breve*19/16~ c'4~ c'\breve*19/16 b4 c'4}
altoFlex = { c'\breve \parenthesize b4 \alto }

tenorIntone = { r8 a4~ }
tenor = { a\breve*19/16 a4 e\breve*19/16~ e4~ e4 }
tenorFlex = { a\breve~ s4 \tenor }

bassIntone = { r8 <a, e>4~ }
bass = { <a, e>\breve*19/16~ <a, e>4 a,\breve*19/16 e,4 a,4 }
