...
altoIntone = { r8 c'4~ }
altoFlex = { c'\breve \parenthesize b4 c'\breve*19/16~ c'4~ c'\breve*18/16 b4 c'4}
alto = { c'\breve*19/16~ c'4~ c'\breve*18/16 b4 c'4}

tenorIntone = { r8 a4~ }
tenorFlex = { a\breve~ s4 a\breve*19/16~ a4 e\breve*18/16~ e4~ e4 }
tenor = { a\breve*19/16 a4 e\breve*18/16~ e4~ e4 }

bassIntone = { r8 <a, e>4~ }
bassFlex = { <a, e>\breve~ s4 <a, e>\breve*19/16~ <a, e>4 a,\breve*18/16 g,4 a,4 }
bass = { <a, e>\breve*19/16~ <a, e>4 a,\breve*18/16 g,4 a,4 }
