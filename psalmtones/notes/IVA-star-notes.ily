...
soprano = { a'\breve g'8 a' b' a'4 \bar "|"
            a'\breve g'8 a' b' g' e'4( fis'4) \bar "||" }
sopranoFlex = {a'\breve \parenthesize g'4 \soprano }

altoIntone = { r8 c'4~ }
alto = { c'\breve*19/16~ c'4~ c'\breve*18/16 b4~ b2}
altoFlex = { c'\breve \parenthesize b4 \alto }

tenorIntone = { r8 a4~ }
tenor = { a\breve*19/16 a4 e\breve*18/16~ e4~ d2 }
tenorFlex = { a\breve~ s4 \tenor }

bassIntone = { r8 <a, e>4~ }
bass = { <a, e>\breve*19/16~ <a, e>4 a,\breve*18/16 g,4 b,2 }
bassFlex = { <a, e>\breve~ s4 \bass }
