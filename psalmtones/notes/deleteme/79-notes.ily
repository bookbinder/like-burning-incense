...
sopranoOneFlex = { \afterGrace a'\breve^"A†" g'4 \breathe a'\breve g'8 a'8 f'4 \bar "|" g'\breve bes'8 a'4 \bar "||"}
sopranoOne = {a'\breve^"A" g'8 a'8 f'4 \bar "|" g'\breve bes'8 a'4 \bar "||"}
sopranoShort = { \override Stem.stencil = ##f
                 \afterGrace a'\breve \parenthesize g'4
                 \revert Stem.stencil
                 g'8 a' f'4 \bar "|" g'\breve bes'8 a'4 \bar "||"  }
sopranoTwoFlex = { \afterGrace a'\breve^"B†" g'4 \breathe a'\breve g'8 a'8 f'4 \bar "|" g'\breve bes'8 a'4 \bar "||"}
