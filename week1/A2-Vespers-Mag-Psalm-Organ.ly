...
\include "notes/A2-Vespers-Mag-Ant.ily"
\include #(string-append "../psalmtones/notes/" psalmtone "-notes.ily")


\header {
    psalm_title = "Magnificat"
    psalm_subtitle = "Problem: Psalm tones don't match. Create new one."
...
%    \set shortVocalName = "1."
 ...
 \ll "My soul proclaims the greatness of the" Lord,
    ...
    \ll "for he has looked with favor on his lowly" servant.

    \ll "From this day all generations will call me bles" -- sed:
    \ll "the Almighty has done great things" for me,
    \ll "and holy is his" Name.

    \ll "He has mercy on those" who "fear him"
    \ll "in every gene" -- ration.

    \ll "He has shown the strength of" his arm,
    \ll "he has scattered the proud in their" conceit.
    ...
    \ll "and the rich he has sent away" empty.
